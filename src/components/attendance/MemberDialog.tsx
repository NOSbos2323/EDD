              ...
              <div className="space-y-1 sm:space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    ...
                    // Auto-update fields when "نصف شهري" is selected
                    if (value === "نصف شهري") {
                      // Set subscription type to 15 sessions
                      handleSelectChange("subscriptionType", "15 حصة");
                      handleSelectChange("sessionsRemaining", "15");
                      handleSelectChange(
                        "subscriptionPrice",
                        getCurrentPrice("15 حصة").toString(),
                      );

                      // Set end date to 15 days from start date
                      const startDate = new Date(
                        formData.membershipStartDate || new Date(),
                      );
              ...
              <div className="space-y-1 sm:space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    // Auto-update end date if membership type is "نصف شهري"
                    if (formData.membershipType === "نصف شهري") {
